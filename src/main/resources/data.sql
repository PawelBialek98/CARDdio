...
VALUES (1, 1, 'pawelzyrafa@gmail.com', true, false, '$2a$10$mXqMy26cyQKbnMed/.hQgO2XhzoxlZLmR1Xs49mCtlzTxcb9LXO4C',
        random_uuid(), parsedatetime('17-09-2019 18:47:52.69', 'dd-MM-yyyy hh:mm:ss.SS')),
       (2, 1, 'test@test.com', true, false, '$2a$10$mXqMy26cyQKbnMed/.hQgO2XhzoxlZLmR1Xs49mCtlzTxcb9LXO4C',
        random_uuid(), parsedatetime('07-02-2020 10:03:12.13', 'dd-MM-yyyy hh:mm:ss.SS')),
       (3, 1, 'test2@test.com', true, false, 'Alakija', random_uuid(),
        parsedatetime('01-08-2020 03:33:55.19', 'dd-MM-yyyy hh:mm:ss.SS')),
       (4, 1, 'test2@test.com', true, false, 'Alakija', random_uuid(),
        parsedatetime('01-08-2019 03:33:55.19', 'dd-MM-yyyy hh:mm:ss.SS'));
...
VALUES (1, 1, 'CLIENT', 'Klient', TRUE, random_uuid()),
...
VALUES (1, 1, parsedatetime('17-09-2012', 'dd-MM-yyyy')),
...
VALUES (1, 1, random_uuid(), 'Oczękująca', 'WAITING', '#31d6c8', 'BEFORE'),
...
VALUES (1, 1, random_uuid(), 'Naprawa Klimatyzacji', 'CLIME', 120, true),
...
VALUES (1, 1, random_uuid(), parsedatetime('25-10-2021 15:00:00', 'dd-MM-yyyy HH:mm:ss'),
        parsedatetime('25-10-2021 17:00:00', 'dd-MM-yyyy HH:mm:ss'), 1, 3, 1, null),
       (2, 1, random_uuid(), parsedatetime('13-05-2023', 'dd-MM-yyyy'),
        parsedatetime('13-05-2023', 'dd-MM-yyyy'), 1, 4, 2, 1),
       (3, 1, random_uuid(), parsedatetime('25-10-2020 20:00:00', 'dd-MM-yyyy HH:mm:ss'),
        parsedatetime('25-10-2020 20:00:00', 'dd-MM-yyyy HH:mm:ss'), 1, 4, 5, null),
       (4, 1, random_uuid(), parsedatetime('25-10-2010 20:00:00', 'dd-MM-yyyy HH:mm:ss'),
        parsedatetime('25-10-2020 20:00:00', 'dd-MM-yyyy HH:mm:ss'), 1, 4, 5, null),
       (5, 1, random_uuid(), parsedatetime('13-05-2023', 'dd-MM-yyyy'),
        parsedatetime('13-05-2023', 'dd-MM-yyyy'), 1, 4, 2, 1),
       (6, 1, random_uuid(), parsedatetime('09-03-2020', 'dd-MM-yyyy'),
        parsedatetime('09-03-2020', 'dd-MM-yyyy'), 2, 1, 3, 1);